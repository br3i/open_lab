...
// Tipo de contenedor
module.exports.ListadoTipoContenedorTodos = async function () {
  var sentencia;
  sentencia = 'SELECT * FROM donacion.f_central_tb_tipo_contenedor($1, $2, $3, $4, $5, $6)'
...
module.exports.ListadoTipoContenedorActivos = async function () {
  var sentencia;
  sentencia = "SELECT * FROM donacion.tb_tipo_contenedor WHERE contenedor_blestado= TRUE"
  try {
