...
module.exports.ActualizarEstadoEmpresa = async function (idEmpresa, empresa_blestado) {
  ...
  try {
    ...
    console.error("Error ejecutando la consulta:", error.message);
    return { data: [`Error: ${error.message}`] };  // Devuelve el error como un string dentro de un array
  }
};

//Encontrara representante activos por idempresa 
...
//Funciones para el Ingreso de Anexos Registro Empresa
