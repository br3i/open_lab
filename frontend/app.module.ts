...
import { PgAreaconocimientoComponent } from './ModuloAdministracion/pg-areaconocimiento/pg-areaconocimiento.component';
import { PgDisponibilidadComponent } from './ModuloAdministracion/pg-disponibilidad/pg-disponibilidad.component';
...
import { PgEstudiosComponent } from './ModuloAdministracion/pg-estudios/pg-estudios.component';
import { PgSituacionlaboralkComponent } from './ModuloAdministracion/pg-situacionlaboralk/pg-situacionlaboralk.component';
import { PgTipovoluntarioComponent } from './ModuloAdministracion/pg-tipovoluntario/pg-tipovoluntario.component';
...
import { PgClasificacionComponent } from './ModuloAdministracion/pg-clasificacion/pg-clasificacion.component';
...
@NgModule({
  declarations: [
    ...
    PgPublicvoluntarioComponent,
    PgPublicbeneficiarioComponent,
    FooteradminComponent,
    HeaderadminComponent,
    MenuadminComponent,
    DashboardadminComponent,
    PgAreaconocimientoComponent,
    PgDisponibilidadComponent,
    PgPrincipaladministracionComponent,
    PgRegistrovoluntarioComponent,
    PgEstudiosComponent,
    PgSituacionlaboralkComponent,
    PgTipovoluntarioComponent,
    PgVoluntariosadminComponent,
    PgVoluntariosprincipalComponent,
    PgRegistrobeneficiarioComponent,
    ...
    PgPrincipalrecepciondonacionComponent,
    PgRecepcionformularioComponent,
    PgRegistrofundacionComponent,
    PgRecepcionconvenioComponent,
    PgDonacionlistarComponent,
    PgRegistropersonaComponent,
    PgPersonalorganizacionComponent,
    PgPrincipalfundacionComponent,
    PgFundacionpendienteComponent,
    PgFundacionaceptadoComponent,
    PgFundaciorechazadoComponent,
    PgPrincipalperfilComponent,
    PgPerfilComponent,
    PgReportedonacionComponent,
    PgClasificacionComponent,
    PgClasificaciondonacionComponent,
    PgPrincipalreporteComponent,
    PgListardistribucionfundacionComponent,
    PgDonacionfundacionComponent,
    PgDonantepersonaComponent,
    PgPrincipaldonantepersonaComponent,
    PgEmpresaeditarComponent,
    PgKitslistarComponent,
    PgVoluntarioaceptadoComponent,
    PgVoluntariorechazadoComponent,
    PgClasificarfundacionComponent
  ],
  imports: [
